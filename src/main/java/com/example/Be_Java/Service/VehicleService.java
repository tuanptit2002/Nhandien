...
public class VehicleService {
    ...
    public ResponseBodyDto<Page<Vehicle>> getVehiclePage(Pageable pageable) {

        Page<Vehicle> vehiclePage =  vehicleRepository.getVehiclePage(pageable);
        return new ResponseBodyDto<>(vehiclePage, "OK","200", vehiclePage.getTotalPages(), vehiclePage.getTotalElements() );
    }
